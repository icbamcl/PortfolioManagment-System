     ...
     <table class="table table-hover" style=" border: 1px solid black;" id="bootstrap-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="CompNonListedMArketPriceEntryForm.aspx?COMP_CD=<%Response.Write(dtallNonlistedComapny.Rows[i]["COMP_CD"].ToString());   %> &TRAN_DATE=<%Response.Write(dtallNonlistedComapny.Rows[i]["TRAN_DATE"].ToString());%> &MARKET_RATE=<%Response.Write(dtallNonlistedComapny.Rows[i]["MARKET_RATE"].ToString());%> " 
