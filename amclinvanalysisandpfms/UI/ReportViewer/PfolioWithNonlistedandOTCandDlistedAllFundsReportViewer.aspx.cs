...
public partial class UI_ReportViewer_CapitalGainAllFundsReportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  DataTable dtReprtSource = new DataTable();
        ...
        sbMst.Append("AS APPRICIATION_ERROTION, ROUND(DECODE(PFOLIO_BK.TCST_AFT_COM * 100,0,0,(((PFOLIO_BK.TOT_NOS * PFOLIO_BK.ADC_RT - PFOLIO_BK.TCST_AFT_COM)/PFOLIO_BK.TCST_AFT_COM * 100)*100)), 8) AS PERCENT_OF_APRE_EROSION, ");
...
" NONLISTED_MARKET_PRICE d on c.comp_cd = d.comp_cd and c.TRAN_DATE = d.TRAN_DATE  order by c.comp_cd  ) d where D.NO_SHARES>0 and D.AMOUNT>0 ) e  inner join NONLISTED_CATEGORY_DETAILS f  on e.CAT_ID = f.CAT_ID order by COMP_NM, CAT_ID  )  ";
        ...
        sbMstOTC.Append("   ROUND((PFOLIO_BK.TOT_NOS * PFOLIO_BK.ADC_RT - PFOLIO_BK.TCST_AFT_COM)  / PFOLIO_BK.TCST_AFT_COM * 100, 8) AS PERCENT_OF_APRE_EROSION, ROUND(PFOLIO_BK.TOT_NOS / COMP.NO_SHRS * 100, 8) AS PERCENTAGE_OF_PAIDUP FROM ");
