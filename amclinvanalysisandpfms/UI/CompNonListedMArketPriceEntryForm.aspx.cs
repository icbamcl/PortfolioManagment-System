...
public partial class UI_NonListedSecuritiesInvestmentEntryForm : System.Web.UI.Page
{
    ...
    protected void nonlistedCompanyDropDownList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataTable dtnonListedCompanyName = commonGatewayObj.Select(" select * from (Select a.COMP_CD,a.COMP_NM,a.SECT_MAJ_CD,a.ADD1,a.ADD2,a.TEL,a.EMAIL,a.AUTH_CAP,a.PAID_CAP,a.CAT_TP,B.MARKET_RATE,B.TRAN_DATE from COMP_NONLISTED  a inner join NONLISTED_MARKET_PRICE b on a.COMP_CD=b.COMP_CD )   Where comp_cd=" + nonlistedCompanyDropDownList.SelectedValue.ToString() + " order by TRAN_DATE DESC  ");
    ...
    protected void saveButton_Click(object sender, EventArgs e)
    {
      ...
      //  string trajectiondate = dtimeTRanjectionDate.ToString("dd-MMM-yyyy");
       ...
       DataTable dtnonListedCompany = commonGatewayObj.Select(strQuery);
        ...
        {
            string strUPQuery = "update NONLISTED_MARKET_PRICE SET MARKET_RATE ='" + rateTextBox.Text.ToString() + "',TRAN_DATE='" + trajectiondate + "'  where  TRAN_DATE='" + trajectiondate + "'  and COMP_CD='" + nonlistedCompanyDropDownList.SelectedValue.ToString() + "'";
        ...
        else
        {
            ...
            strInsQuery = "insert into NONLISTED_MARKET_PRICE(COMP_CD,TRAN_DATE,MARKET_RATE)values('" + nonlistedCompanyDropDownList.SelectedValue.ToString() + "','" + trajectiondate + "','" + rateTextBox.Text.ToString() + "')";
    ...
    {
        DataTable dtnonListedCompanyName = commonGatewayObj.Select(" Select a.COMP_CD,a.COMP_NM,a.SECT_MAJ_CD,a.ADD1,a.ADD2,a.TEL,a.EMAIL,a.AUTH_CAP,a.PAID_CAP,a.CAT_TP,B.MARKET_RATE,B.TRAN_DATE from COMP_NONLISTED  a inner join NONLISTED_MARKET_PRICE b on a.COMP_CD=b.COMP_CD  order by TRAN_DATE DESC ");
